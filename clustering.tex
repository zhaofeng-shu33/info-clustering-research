...
\end{equation*} 
Since $I(Z_V)$ is minimum value, then we have $I_{\P_1 \wedge \P_2}(Z_V)=I(Z_V)$.
\end{proof}
...
pratical computations, the maximal flow algorithm can only compute one set (minimzer).
