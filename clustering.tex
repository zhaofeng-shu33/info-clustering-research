...
If there are multiple solutions to \eqref{eq:beta}.

If our max flow algorithm gives maximum source size result, then using  $\beta^l$ method we will get the solution to $\alpha^l$ with minimum $S$.
