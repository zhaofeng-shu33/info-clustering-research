...
Algorithm \ref{alg:pmfT} is theoretical computable. To make it possible to implemetation, we need to figure out how to solve $\tilde{\lambda}_2$ and how to compute $\tilde{h}(\lambda)$ for given $\lambda$ efficiently.
