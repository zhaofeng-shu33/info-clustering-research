...
For the three groups of data: \textsf{Gaussian}, \textsf{Circle} and \textsf{Iris}. The first two have some intrinsic randomness. To make the result reproducible, we use fixed random seed to generate the data. The three cirlces data is generated using polar coordinate:
\begin{align*}
...
Different algorithms flavor different data pre-processing way.
