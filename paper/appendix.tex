...
\end{proof}
Proposition \ref{prop:reweight} shows that under certain conditions the graph $G$ is robust enough since complete linkage between the two clusters cannot destroy its structure.	
