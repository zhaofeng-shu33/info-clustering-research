...
Proposition \ref{prop:reweight} tells us there is no other clusters except for $S_1, S_2$ and singletons. It inspires us to increase the weight linearly with the number of nodes for densely connected part of the whole community. It increases the performance of info-clustering algorithm.
