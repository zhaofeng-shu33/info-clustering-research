...
\end{equation}
This is the number of triangles which contain the edge. By such definition we can show that two complete graph with size $n$ can be clustered rightly if the number of their inter-connected edge is less than $\frac{n^2}{2}$.
