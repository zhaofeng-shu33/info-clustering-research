...
In this paper, we have analyzed the existing model of info-clustering and extends it to data clustering and community detection scenario. It is suitable to use info-clustering if the size of data samples are small or medium sized. We have proposed a parametric computing scheme. Combined with parametric maximum flow, we can efficiently get the hierarchical structure of info-clustering.
